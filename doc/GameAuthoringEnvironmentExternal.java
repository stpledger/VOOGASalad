 ...
 * module only defines how we will pass the {@code GameState} object to the Data team.
 * @author dylanpowers
 *
 */
public interface GameAuthoringEnvironmentExternal {
	 ...
	 * @return a GameState object that represents the current state of the game
	 */
